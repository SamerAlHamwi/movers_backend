...
namespace Mofleet.Web.Tests
{
    public abstract class MofleetWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MofleetWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MofleetWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MofleetDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MofleetDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MofleetDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MofleetDbContext, Task<T>> func)
        {
            T result;
