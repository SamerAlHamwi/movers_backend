...
namespace Mofleet.CrudAppServiceBase
{
    [DisableAuditing]
    public abstract class MofleetAsyncCrudAppService<TEntity, TEntityDto, TPrimaryKey, TLiteEntityDto, TGetAllInput, TCreateInput, TUpdateInput>
      : MofleetCrudAppServiceBase<TEntity, TEntityDto, TPrimaryKey, TLiteEntityDto, TGetAllInput, TCreateInput, TUpdateInput>,
          IMofleetAsyncCrudAppService<TEntityDto, TPrimaryKey, TLiteEntityDto, TGetAllInput, TCreateInput, TUpdateInput>
      ...
      where TUpdateInput : IEntityDto<TPrimaryKey>
    {
        ...
        protected MofleetAsyncCrudAppService(IRepository<TEntity, TPrimaryKey> repository)
            : base(repository)
        {
