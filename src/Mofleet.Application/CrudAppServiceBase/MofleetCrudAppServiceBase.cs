...
{
    public abstract class MofleetCrudAppServiceBase<TEntity, TEntityDto, TPrimaryKey, TLiteEntityDto, TGetAllInput, TCreateInput, TUpdateInput>
      : ApplicationService
      ...
      where TUpdateInput : IEntityDto<TPrimaryKey>
    {
        ...
        protected MofleetCrudAppServiceBase(IRepository<TEntity, TPrimaryKey> repository)
        {
