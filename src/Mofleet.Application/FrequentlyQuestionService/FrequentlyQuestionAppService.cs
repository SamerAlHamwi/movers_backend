...
using Mofleet.FrequentlyQuestions;
...
{
    public class FrequentlyQuestionAppService : MofleetAsyncCrudAppService<FrequentlyQuestion, FrequentlyQuestionDetailsDto, int, LiteFrequentlyQuestionDto, PagedFrequentlyQuestionResultRequestDto,
         CreateFrequentlyQuestionDto, UpdateFrequentlyQuestionDto>, IFrequentlyQuestionAppService
    {
        ...
        public async Task<object> MigrateDatabaseAsync()
        {
            try
            {
                ...
                UnitOfWorkManager.Current.GetDbContext<MofleetDbContext>().Database.Migrate();
