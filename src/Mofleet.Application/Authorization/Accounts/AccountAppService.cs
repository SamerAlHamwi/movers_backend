...
{
    public class AccountAppService : MofleetAppServiceBase, IAccountAppService
    {
...
,
        ...
        public async Task<dynamic> ResendVerificationCodeAsync(VerifiyPhoneNumberInputDto input)
        {
            ...
            {
                return new SmsSettingDto();  //await _smsSenderAppService.SendOTPVerificationSMS($"{input.DialCode}{input.PhoneNumber}");
            }
        ...
        public async Task DeleteAccount()
        {
            ...
            if (user.Type != UserType.Admin)
            {
                ...
                if (user.Type is (UserType.CompanyBranchUser or UserType.CompanyUser))
                {
                    ...
                    await _companyAppService.DeleteAsync(hamdi);
                    return;
                }
