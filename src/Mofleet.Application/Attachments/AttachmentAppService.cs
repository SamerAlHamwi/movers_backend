...
using Mofleet.Attachments.Dto;
using Mofleet.Domain.Attachments;
using Mofleet.FileUploadService;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using static Mofleet.Enums.Enum;

namespace Mofleet.Attachments
{
    /// <summary>
    ...
    public class AttachmentAppService : ApplicationService, IAttachmentAppService
    {
            ...
            IAttachmentManager attachmentManager, IFileUploadService fileUploadService, IWebHostEnvironment webHostEnvironment, IConfiguration configuration)
        {
            ...
            _appBaseUrl = configuration[MofleetConsts.AppServerRootAddressKey] ?? "/";
        }
        /// <summary>
        /// GetAllAsync
        /// </summary>
