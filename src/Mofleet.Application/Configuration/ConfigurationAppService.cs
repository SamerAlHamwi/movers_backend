...
{
    [AbpAuthorize]
    public class ConfigurationAppService : MofleetAppServiceBase, IConfigurationAppService
    {
        ...
        {
            var enumTypes = typeof(Enums.Enum).Assembly.GetTypes().Where(t => t.IsEnum && t.Namespace == MofleetConsts.EnumNameSpace);
