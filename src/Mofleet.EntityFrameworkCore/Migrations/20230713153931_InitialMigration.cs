        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SourceLocationType = table.Column<byte>(type: "tinyint", nullable: false),
                    PropertyForSourceLocationType = table.Column<byte>(type: "tinyint", nullable: false),
                    AppartmentType = table.Column<byte>(type: "tinyint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceRegionId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FirstNameContact = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastNameContact = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IsAnElevator = table.Column<bool>(type: "bit", nullable: true),
                    PackagingService = table.Column<bool>(type: "bit", nullable: true),
                    PackagingMaterials = table.Column<bool>(type: "bit", nullable: true),
                    NumberOfAdhesive = table.Column<int>(type: "int", nullable: true),
                    NumberOfCardboardBoxes = table.Column<int>(type: "int", nullable: true),
                    NumberOfVehicleForHeavyFurniture = table.Column<int>(type: "int", nullable: true),
                    UnpackingService = table.Column<bool>(type: "bit", nullable: true),
                    InstallationService = table.Column<bool>(type: "bit", nullable: true),
                    CoatingService = table.Column<bool>(type: "bit", nullable: true),
                    RequestForQuotationId = table.Column<long>(type: "bigint", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
