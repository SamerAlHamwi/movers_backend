...
namespace Mofleet.Migrations
{
    ...
    [Migration("20230713201648_AddAdvertisimentTable")]
    partial class AddAdvertisimentTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mofleet.Domain.AttributesForSourceType.AttributeForSourcType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<byte?>("AppartmentType")
                        .HasColumnType("tinyint");
                    ...
                    b.Property<byte>("PropertyForSourceLocationType")
                        .HasColumnType("tinyint");

                    b.Property<byte>("SourceLocationType")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Mofleet.Domain.AttributeForSourcTypeValues.AttributeForSourceTypeValue", b =>
                {
                    b.HasOne("Mofleet.Domain.AttributesForSourceType.AttributeForSourcType", "AttributeForSourcType")
                        .WithMany()
            ...
            modelBuilder.Entity("Mofleet.Domain.RequestForQuotations.RequestForQuotation", b =>
                {
                    b.HasOne("Mofleet.Domain.Regions.Region", "DestinationRegion")
                        .WithMany()
                        .HasForeignKey("DestinationRegionId");

                    b.HasOne("Mofleet.Domain.Regions.Region", "SourceRegion")
                        .WithMany()
